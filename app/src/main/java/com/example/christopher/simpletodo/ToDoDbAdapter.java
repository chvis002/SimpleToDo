...
public class ToDoDbAdapter {
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            initialValues.put(KEY_TITLE, "Titel 1");
            initialValues.put(KEY_TITLE, "Titel 2");
            initialValues.put(KEY_BODY, "Hejsan");
            initialValues.put(KEY_BODY, "Hoppsan");
    ...
    public long createToDo(ToDoTask task) {

        String title = task.getTaskTitle();
        String body = task.getTaskText();
